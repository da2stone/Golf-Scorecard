...
function getScorecardResultFromRow(row) {
    ...
    let scoreList = Object.values(row).slice(3,21);
    let parList = Object.values(row).slice(21,39);
...
module.exports = {populateStatsFromScorecardList, getScorecardResultFromRow}